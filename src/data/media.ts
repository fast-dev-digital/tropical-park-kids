...
export const mediaAssets = {
  ...
  decoracaoFazendinhaAzul: photo(
    'decoracao-fazendinha-azul',
    'decoracao-new-2.webp',
    'Mesa de doces com decoração fazendinha em tons de azul',
    'Decoração fazendinha',
    'landscape',
    ['events', 'gallery'],
    'featured',
    'center',
  ),
  entradaFazendinha: photo(
    'entrada-fazendinha',
    'entrada-new.webp',
    'Entrada com cenário fazendinha, balões e lembrancinhas infantis',
    'Entrada fazendinha',
    'portrait',
    ['events', 'location', 'gallery'],
    'featured',
    'center',
  ),
  decoracaoFazendinhaDoces: photo(
    'decoracao-fazendinha-doces',
    'decoracao-new.webp',
    'Mesa de doces fazendinha com balões azuis e detalhes rústicos',
    'Mesa fazendinha',
    'portrait',
    ['events', 'gallery'],
    'featured',
  ...
  centopeiaChacara: photo(
    ...
    'portrait',
    ['attractions', 'differentials', 'gallery'],
    'featured',
    'center',
  ),
  ...
  entradaSalao: photo(
    ...
    'Chegada ao salão',
    'portrait',
    ['location', 'differentials', 'gallery'],
    'featured',
    'center',
  ),
  ...
  salaoInfantil: photo(
    ...
    'Salão infantil com trator cenográfico, balões e entrada decorada',
    'Salão infantil',
    'portrait',
    ['attractions', 'gallery'],
    'support',
  ...
  menuCoquetelTabua: photo(
    ...
    'Tábua com cubos de queijo, presunto, azeitonas verdes e pretas, castanhas e amêndoas',
    'Tábua de antepasto',
    'portrait',
    ['menus', 'gallery'],
    'featured',
